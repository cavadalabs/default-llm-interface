...
# What kind of message should be shown when someone gives an AI answer feedback to Assistant Bot
...
# Should Assistant Bot send an apology message if it's not able to find an answer
# That way the user isn't confused as to why Assistant Bot reacted but then said nothing
...
# if Assistant Bot couldn't find an answer
...
# responses Assistant Bot can send in a given time period.
