        ...
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Web Search Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Internet search tool requires a search provider API key, please contact your admin to get it added!"
                    )
            ...
            # Handle Open URL Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Open URL tool requires a web content provider, please contact your admin to get it configured!"
                    )
