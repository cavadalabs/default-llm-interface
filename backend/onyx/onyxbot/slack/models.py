...
class SlackMessageInfo(BaseModel):
    ...
    sender_id: str | None
    email: str | None
    bypass_filters: bool  # User has tagged @Assistant Bot
    is_slash_command: bool  # User is using /Assistant Bot
    is_bot_dm: bool  # User is direct messaging to Assistant Bot
