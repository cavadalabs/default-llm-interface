...
def build_html_email(
    ...
    if application_name == ONYX_DEFAULT_APPLICATION_NAME:
        community_link_fragment = f'<br>Have questions? Contact support <a href="{ONYX_DISCORD_URL}">here</a>.'
...
def send_email_with_sendgrid(
    ...
    from_email = Email(mail_from) if mail_from else Email("noreply@cavadalabs.com")
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="cavadalabs.com")
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    cta_link = "https://www.cavadalabs.com"
    ...
    text_content = (
        ...
        "If you change your mind, contact your administrator or CavadaLabs support."
    )
    send_email(
        user_email,
        subject,
