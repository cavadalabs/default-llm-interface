    ...
    <>
      <InputPadder>
        <Section gap={1}>
          ...
          <InputVertical
            ...
            subDescription="Choose how the application should authenticate with Bedrock."
          >
      ...
      {authMethod === AUTH_METHOD_IAM && (
        <InputPadder>
          <MessageCard
            variant="info"
            title="The application will use the IAM role attached to the environment it’s running in to authenticate."
          />
        </InputPadder>
      )}
