...
function buildCopy(
  ...
  if (stage === "t_30d") {
    return {
      title: `Your application license expires on ${expiresDisplay}.`,
      description:
        "Renewal is due in approximately 30 days. Contact your application representative to renew.",
      variant: "warning",
    };
  }
  if (stage === "t_14d") {
  ...
  if (stage === "t_1d") {
    return {
      title: `Your application license expires tomorrow (${expiresDisplay}).`,
      description:
  ...
  if (stage === "grace") {
    return {
      title: `Your application license expired on ${expiresDisplay}.`,
