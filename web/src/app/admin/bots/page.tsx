  ...
  return (
    <div className="mb-8">
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to the application. Once setup, you will
        be able to ask questions to the application directly from Slack.
      ...
      <div className="mb-2">
        <ul className="list-disc mt-2 ml-4 text-sm text-muted-foreground">
          <li>
            Setup Assistant Bot to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets Assistant Bot should answer from,
            depending on the channel the question is being asked.
          </li>
          <li>
            Directly message Assistant Bot to search just as you would in the
            web UI.
          </li>
        </ul>
      </div>
      ...
      <p className="mb-6 text-sm text-muted-foreground">
        ...
        found in the application documentation to get started!
      </p>
