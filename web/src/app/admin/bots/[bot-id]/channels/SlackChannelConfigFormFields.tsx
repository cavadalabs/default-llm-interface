      ...
      <div className="w-full">
          ...
          <>
            ...
            <div className="mt-4 p-4 bg-background rounded-md border border-neutral-300">
              ...
              <p className="mt-2 text-sm italic">
                Warning: Disabling the default configuration means Assistant Bot
                won&apos;t respond in Slack channels unless they are explicitly
                configured. Additionally, Assistant Bot will not respond to DMs.
              </p>
            </div>
          </>
        )}
        ...
        <div className="space-y-2 mt-4">
          ...
          >
            <RadioGroupItemField
              ...
              sublabel="Let Assistant Bot respond based on information from all public connectors"
            />
        ...
        {values.knowledge_source === "document_sets" &&
          documentSets.length > 0 && (
            <div className="mt-4">
              <SubLabel>
                <>
                  Select the document sets Assistant Bot will use while
                        ...
                        <div className="mb-3 mt-2 flex gap-2 flex-wrap text-sm">
                          {unselectableSets.map((documentSet) => (
                            <DocumentSetCard
                              ...
                              documentSet={documentSet}
                              disabled
                              disabledTooltip="Unable to use this document set because it contains a connector with auto-sync permissions. Assistant Bot's responses in this channel are visible to all Slack users, so mirroring the asker's permissions could inadvertently expose private information."
                              isSelected={false}
                            />
                          ))}
                        </div>
        ...
        {values.knowledge_source === "assistant" && (
          <div className="mt-4">
            <SubLabel>
              <>
                Select the search-enabled agent Assistant Bot will use while
                answering questions in Slack.
        ...
        {values.knowledge_source === "non_search_agent" && (
          <div className="mt-4">
            <SubLabel>
              <>
                Select the non-search agent Assistant Bot will use while
                answering questions in Slack.
                {syncEnabledAgents.length > 0 && (
                  <>
                    <br />
              ...
              <div className="space-y-4 pb-3">
                <div className="w-64">
                  <SelectorFormField
                    name="response_type"
                    label="Answer Type"
                    tooltip="Controls the format of Assistant Bot's responses."
                    options={[
          ...
          <AccordionContent className="overflow-visible">
            <div className="space-y-4">
              <CheckboxField
                ...
                tooltip="If set, will show a button at the bottom of the response that allows the user to continue the conversation in the application Web UI"
              />
              ...
              <CheckboxField
                ...
                tooltip={`Assistant Bot's response will include a button at the bottom
              ...
              <CheckboxField
                ...
                tooltip="If set, Assistant Bot will only respond to messages that contain a question mark"
              />
              <CheckboxField
                name="respond_tag_only"
                label="Respond to @Assistant Bot Only"
                tooltip="If set, Assistant Bot will only respond when directly tagged"
              />
              <CheckboxField
                name="respond_to_bots"
                label="Respond to Bot messages"
                tooltip="If not set, Assistant Bot will always ignore messages from Bots"
              />
              <CheckboxField
                name="is_ephemeral"
                label="Respond to user in a private (ephemeral) message"
                tooltip="If set, Assistant Bot will respond only to the user in a private (ephemeral) message. If you also
              ...
              <TextArrayField
                ...
                subtext={
                  ...
                  "Assistant Bot in this channel, and responses are visible only " +
                  "to them."
                }
                values={values}
                placeholder="User email or user group name..."
