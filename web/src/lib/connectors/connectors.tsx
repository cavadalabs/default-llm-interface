...
> = {
  web: {
    ...
    values: [
      {
        type: "text",
        query: "Enter the website URL to scrape e.g. https://www.example.com/:",
        label: "Base URL",
        name: "base_url",
        optional: false,
      },
  ...
  google_drive: {
            ...
            fields: [
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow the application to index everything in the shared drives you have access to."
                    : "This will allow the application to index everything in your Organization's shared drives.";
                },
              ...
              },
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow the application to index everything in your My Drive."
                    : "This will allow the application to index everything in everyone's My Drives.";
                },
              ...
              },
              {
                type: "checkbox",
                description:
                  "This will allow the application to index all files shared with you.",
    ...
    advanced_values: [
      ...
      },
      {
        ...
        description:
          "When enabled, the application skips files that are shared broadly (domain or public) but require the link to access.",
...
• Specifying sites currently works for SharePoint instances using English, Spanish, or German. Contact the support team if you need another language supported.
`,
      },
    ],
    advanced_values: [
      ...
      },
      {
        ...
        description:
          ...
          "are treated as public (visible to all application users). " +
