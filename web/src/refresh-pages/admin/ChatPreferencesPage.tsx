      ...
      <SettingsLayouts.Root>
        ...
        <SettingsLayouts.Body>
          ...
          <Section gap={1}>
            ...
            >
              <InputTextArea
                placeholder="Describe your team and how the application should behave."
                rows={4}
                maxRows={10}
                autoResize
                  ...
                  <Section>
                    ...
                    >
                      <InputHorizontal
                        ...
                        description="Specify how long the application should retain chats in your organization."
                        tag={
                          !enterpriseTier
                            ? {
