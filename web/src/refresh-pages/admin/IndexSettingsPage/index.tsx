...
const CLOUD_TOOLTIP = "This setting is managed by the hosted environment.";

/**
 * Wrapper that disables its children when either:
 * 1. The app is running in hosted mode (`NEXT_PUBLIC_CLOUD_ENABLED`), or
...
export default function IndexSettingsPage() {
  ...
  /**
   * Persist a new default vision model. the application routes all image-captioning
                ...
                <>
                  ...
                  >
                    <Content
                      ...
                      description="This application uses this model to encode documents for search and retrieval."
                      ...
                      <CloudDisabled>
                        <Card border="solid" rounding="lg" padding="sm">
                          <GeneralLayouts.Section padding={0.5}>
                            <Content
                              icon={SvgVector}
                              title="Embedding model and settings are managed by the hosted environment."
                              sizePreset="main-ui"
                              variant="section"
                            />
                          </GeneralLayouts.Section>
