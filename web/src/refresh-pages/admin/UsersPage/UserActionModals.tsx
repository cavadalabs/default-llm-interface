  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will no longer be able to join the application with this invite.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will immediately lose access to the application. Their sessions and
        agents will be preserved. Their license seat will be freed. You can
        reactivate this account later.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will regain access to the application.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will be permanently removed from the application. All of their session
        history will be deleted. Deletion cannot be undone.
      </Text>
    </ConfirmationModalLayout>
  );
}
